...
Version `0.10.14` fixes Voyage Review so the basemap-only chart-cycle step
...
```bash
cd ~/.signalk
npm install git+https://github.com/ajrm-marine-suite/signalk-ajrm-marine-capture.git#v0.10.14 --omit=dev --no-package-lock
