...
Version `0.10.6` provides one voyage player for saved-result playback,
...
```bash
cd ~/.signalk
npm install git+https://github.com/ajrm-marine-suite/signalk-ajrm-marine-capture.git#v0.10.6 --omit=dev --no-package-lock
