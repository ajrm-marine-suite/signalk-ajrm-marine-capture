...
Version `0.10.10` adds a package-root Webapps icon while retaining replay source-time alignment and
...
```bash
cd ~/.signalk
npm install git+https://github.com/ajrm-marine-suite/signalk-ajrm-marine-capture.git#v0.10.10 --omit=dev --no-package-lock
